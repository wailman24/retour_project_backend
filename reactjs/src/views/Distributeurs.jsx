...
export default function Distributeurs() {
    ...
    const records = distributeurs.slice(firstIndex, lastIndex);
    const npage = Math.ceil(distributeurs.length / recordsPerPage);
    ...
    const openDeleteModal = (d) => {
        setIsOpenD(!isOpenD);
        setDeleteDistributeur(d);
    };

    const handleDelete = () => {
        axiosClient
            .delete(`/distributeurs/${DeleteDistributeur.id}`)
            .then(() => {
                setIsOpenD(!isOpenD);
                window.location.reload();
            });
    ...
    const onUpdate = (ev) => {
        ev.preventDefault();
        axiosClient
            .put(`/distributeurs/${distributeurUpdate.id}`, distributeurUpdate)
            .then(() => {
                setIsOpenU(!isOpenU);
                window.location.reload();
            })
                                                ...
                                                <div className="grid gap-4 mb-4 sm:grid-cols-2">
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            id="location"
                                                            value={
                                                                distributeurUpdate.location
                                                            }
                                                            onChange={(ev) =>
                                                                setdistributeurUpdate(
                                                                    {
                                                                        ...distributeurUpdate,
                                                                        location:
                                                                            ev
                            ...
                            <form class="max-w-xs mx-auto">
                                <div class="relative">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setSearch_location(e.target.value)
                                        }
                                    />
                                </div>
                            </form>
                            ...
                            {!loading && (
                                <tbody>
                                    {records
                                        ...
                                        .filter((d) => {
                                            return search_location.toLowerCase() ===
                                                ""
                                                ? d
                                                : d.location
                                                      .toLowerCase()
