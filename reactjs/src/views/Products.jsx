...
export default function Products() {
    ...
    const [search_mname, setSearch_mname] = useState("");
    const [search_Imei, setSearch_Imei] = useState("");
    const [search_dname, setSearch_dname] = useState("");
    ...
    const getDistributeurs = () => {
        setLoading(true);
        axiosClient
            .get("/distributeurs")
            .then(({ data }) => {
                setLoading(false);
                setDistributeurs(data.data);
            })
            .catch(() => {
                setLoading(false);
            });
    ...
    const handleDelete = () => {
        axiosClient.delete(`/products/${DeleteProduct.id}`).then(() => {
            setIsOpenD(!isOpenD);
            window.location.reload();
        });
    };
    ...
    const onUpdate = (ev) => {
        ev.preventDefault();
        axiosClient
            .put(`/products/${productUpdate.id}`, productUpdate)
            .then(() => {
                setIsOpenU(!isOpenU);
                window.location.reload();
            })
                            ...
                            <form className="max-w-xs mx-auto">
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setSearch_mname(e.target.value)
                                        }
                                    />
                                </div>
                            </form>
                            ...
                            <form className="max-w-xs mx-auto">
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        id="floating-phone-number"
                                        className="block py-2.5 ps-6 pe-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                        placeholder="  Distributeur name"
                                        onChange={(e) =>
                                            setSearch_dname(e.target.value)
                                        }
                                    />
                                </div>
                            </form>
                            ...
                            {!loading && (
                                <tbody>
                                    {products
                                        ...
                                        .filter((p) => {
                                            return search_Imei.toLowerCase() ===
                                                ""
                                                ? p
                                                : p.Imei.toLowerCase().includes(
                                                      search_Imei
                                                  );
                                        })
                                        .filter((p) => {
                                            return search_mname.toLowerCase() ===
                                                ""
                                                ? p
                                                : p.modal
                                                      .toLowerCase()
                                                      .includes(search_mname);
                                        })
                                        .filter((p) => {
                                            return search_dname.toLowerCase() ===
                                                ""
                                                ? p
                                                : p.distributeur
                                                      .toLowerCase()
                                                      .includes(search_dname);
                                        })
